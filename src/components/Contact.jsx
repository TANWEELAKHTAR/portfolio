...
const Contact = () => {
  return (
    <div className='col-span-2 md:col-span-4 row-span-5 bg-black text-white rounded-lg'>
      <div className="w-full h-full flex flex-col justify-between items-start p-6 cursor-pointer">
